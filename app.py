...
def reqToServer():
    ...
    try:
        ...
        common_keyword={"전국","조기","지난","참가자들","피해","현장","대비","2023","있는","따르","오후","오전","경찰","열린","사건","따르면","받는",
                        ...
                        "글로벌","개발","공식","기업","고객","공식","대표","매출","브랜드","상반기","서비스","세계",
                        "스마트폰","올해","출시","케이스","패키지","함께","후보자","공개","기술","나선","시리즈","시장","전년","전략적",
                        "전문","제25회","초청해","진행","인사","방송","모바일","마련된","YTN","vip","뉴스","신규","연구","영상",
                        "캐릭터","페이지에","검증","관련","오픈","특별","이벤트","제품","준비","구축","제공","영업이익","영업","이익",
                        "콘텐츠","가운데","금융","기준","대한","사업","사장","상승","실적","아파트","연결","오른","이어","최대","최소",
                        "정부","지원","최근","투자","판매","개최","구속","남성","여성","대원들","동영상","사고","앞에서","지원","참가한",
                        "영향","다시","국제","슈퍼","열리","열리는","영향","해제","하와","인파","규모","만에","발생","회의","더불어민",
                        "동영상기사","상병","수사","원내","의원","장관","하고","혁신","경제","기록했다고","누락","단지","대상","발표","부사장",
                        "부회장","수출","이번","자회사","적자","지역","운전자","지역","중심으로","라이브","제6호","예능","오늘","동영상기","특파원",
                        "문제","대형","업데이트","실시","나선다","동기","맞아","연속","감소","인근에서","지나간","모두","최다","속보","추가","확진",
                        "발언","조사","기자","기사","맞아","행사","아침까지","방문한","내일","날씨","시연","대원","국회","대의원제","돌파","이날",
                        "이후","체결","재판에","사무관","곳곳","우리","내리","합의","우려","자금","운영","기소","안전","시민","미래","어린","위기",
                        "사무실로","우수","K팝","찾아","물놀","가격","만기","나타났다","중단","하나","주요","사과","책임","대해","회원들","회원","속에",
                        "시작","종료","최고","발생한","최악","상징","파라과","출신","강력한","집권","방문","전국적인","참여","인터뷰하고","대상으로",
                        "열렸다","협업한","주말","하락","나타났다","20","대부분","협력해","출범","자체","참관객들","것으","내린"
                        }
        region1={
